export default function Loading() {
  return (
    <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '1rem' }}>
      <div style={{ height: '3rem', width: '220px', background: 'rgba(255,255,255,0.04)', borderRadius: '10px', marginBottom: '1.5rem', animation: 'pulse 1.5s ease-in-out infinite' }} />
      <div style={{ display: 'flex', gap: '10px', marginBottom: '2.5rem' }}>
        <div style={{ height: '40px', width: '110px', background: 'rgba(255,255,255,0.04)', borderRadius: '8px', animation: 'pulse 1.5s ease-in-out infinite' }} />
        <div style={{ height: '40px', width: '110px', background: 'rgba(255,255,255,0.04)', borderRadius: '8px', animation: 'pulse 1.5s ease-in-out infinite' }} />
      </div>
